...
namespace SO_simulation_csharp
{
    ...
    class LCFS
    {
        ...
        {
            FileInfo fileInfo = new FileInfo(@"C:\Users\artur\Desktop\wyniki symulacji\wynikiLCFS.txt");
            StreamWriter streamWriter = fileInfo.CreateText();
            streamWriter.WriteLine("LCFS average waiting times for each sequence:");
            ...
            streamWriter.WriteLine("LCFS average turnaround times for each sequence:");
